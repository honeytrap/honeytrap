...
func ListenSIP(address string, m *director.ContainerConnections, d director.Director, p *pushers.Pusher, e pushers.Events, c *config.Config) (net.Listener, error) {
