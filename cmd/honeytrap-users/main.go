...
var log = logging.MustGetLogger("honeytrap/cmd/honeytrap-users")
...
func VersionAction(c *cli.Context) {
	fmt.Println(color.YellowString(fmt.Sprintf("Honeytrap-users: CLI to interact and query the honeytrap service for user details.")))
}

func main() {
	app := cli.NewApp()
	app.Name = "honeytrap-users"
	app.Author = ""
	app.Usage = "honeytrap-users"
