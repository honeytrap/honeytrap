...
func VersionAction(c *cli.Context) {
	fmt.Println(color.YellowString(fmt.Sprintf("Honeytrap create: Providing container creation CLI.")))
}
...
func main() {
	app := cli.NewApp()
	app.Name = "honeytrap-create"
	app.Author = ""
	app.Usage = "honeytrap-create"
	app.Flags = globalFlags
	app.Description = `The honeypot CLI tool to create containers.`
