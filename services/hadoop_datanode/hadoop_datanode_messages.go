	...
	return fmt.Sprintln(`
		{
		  "beans" : [ {
		    ...
		    "RpcPort" : "50020",
		    "HttpPort" : null,
		    "NamenodeAddresses" : "{\"3d77dfef150d\":\"BP-1961412683-172.17.0.32-1450036414523\"}",
		    "VolumeInfo" : "{\"/tmp/hadoop-root/dfs/data/current\":{\"freeSpace\":14493519872,\"usedSpace\":327680,\"reservedSpace\":0}}",
